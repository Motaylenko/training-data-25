...
public class BasicDataOperationUsingSet {
    ...
    public void executeDataAnalysis() {
        ...
        DataFileHandler.writeArrayToFile(doubleArray,
                BasicDataOperation.PATH_TO_DATA_FILE + ".sorted");
    }
    ...
    private void locateMinMaxInArray() {
        ...
        double minValue = Collections.min(Arrays.asList(doubleArray));
        double maxValue = Collections.max(Arrays.asList(doubleArray));

        PerformanceTracker.displayOperationTime(timeStart,
                "визначення мiнiмальної i максимальної дати в масивi");
    ...
    private void findInSet() {
        ...
        boolean elementExists = doubleSet.stream()
                .anyMatch(value -> value.equals(doubleValueToSearch));

        PerformanceTracker.displayOperationTime(timeStart,
                "пошук елемента в LinkedHashSet дійсного числа");
    ...
    private void locateMinMaxInSet() {
        ...
        PerformanceTracker.displayOperationTime(timeStart,
                "визначення мiнiмальної i максимальної дати в LinkedHashSet");
    ...
    private void analyzeArrayAndSet() {
        ...
        boolean allElementsPresent = Arrays.stream(doubleArray)
                .allMatch(doubleSet::contains);
